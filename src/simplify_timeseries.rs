...
use distance_functions::{distance_point_to_line_2d, distance_point_to_line_squared};

// struct Setup<const N: usize> {
//     dt: f64,
//     epsilon: f64,
//     outfiles: &mut [BufWriter<File>; N],
...
fn recursively_simplify_with_time(
        ...
        .skip(first_element + 1)
    {
        ...
        let square_distance = distance_point_to_line_2d(&a, &b, &mid_point);
